...
const PersonalLandingPage = () => {
    ...
    const FORMSPARK_ACTION_URL = "https://submit-form.com/iFdC8wLoM"; 
    ...
    <div className="min-h-screen bg-[#ffffff] flex justify-left p-8 ">
      <div className="w-full max-w-[600px] flex flex-col justify-between">
        <header className="mb-8">
          <h1 className="text-3xl font-bold text-[#001122]">
        ...
        <footer className="text-[#888888] text-xl">
          <section>
            <p className="text-[#888888]">
        ...
        <footer className="mt-8 pt-4 border-t border-[#dddddd] text-[#888888]">
